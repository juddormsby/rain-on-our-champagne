  ...
  return (
    <div className="about-container">
      <div className="about-content">
        ...
        <p>This app shows the chance of rain and typical temperature ranges for any day and champagne session – morning, noon, afternoon, or evening.</p>
        ...
        <p>Data is ERA5-reanalysis via open-meteo API.</p>
        
        <h2>Poultry who?</h2>
        
        <p>Poultry is an intelligent chicken that has opinions on champagne, running, cycling, swimming, and other matters.</p>
